...
<main>
  ...
  <div class="loader">
    ...
    <div class="loader-anim2 color-bg" />
  </div>
  <!-- loader  end-->
  <!-- main start  -->
  <div id="main">
    ...
    <aside class="left-header">
      <span class="lh_dec color-bg" />
      <div class="left-header_social">
        <ul>
          <li>
            <a href="#" target="_blank"><i class="fab fa-facebook-f" /></a>
          </li>
          <li>
            <a href="#" target="_blank"><i class="fab fa-instagram" /></a>
          </li>
          <li><a href="#" target="_blank"><i class="fab fa-twitter" /></a></li>
          <li><a href="#" target="_blank"><i class="fab fa-vk" /></a></li>
        </ul>
      </div>
    </aside>
    <!-- left-header end-->
    ...
    <div class="share-btn showshare color-bg">
      <span>Share <i class="fal fa-plus" /></span>
    </div>
    <!-- share button end-->
    <!-- right header-->
    <div class="hc_dec_color">
      <div class="page-subtitle"><span /></div>
    </div>
    <!-- right header end-->
    <!-- wrapper  -->
    <div id="wrapper">
      ...
      <div class="nav-holder">
        <div class="nav-holder-wrap but-hol">
          ...
          <div class="nav-holder-wrap_line" />
          <div class="nav-holder-wrap_dec" />
        </div>
      </div>
        ...
        <div class="fl-wrap full-height hero-conatiner">
          <div class="hero-wrapper fl-wrap full-height hidden-item">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="half-hero-wrap">
                        ...
                        <h1>
                          Sandy Plegas - <br /><span> Web developer</span> and
                          designer<br /> form
                          <span>USA</span>
                        </h1>
                        <h4>
                    ...
                    <div class="swiper-slide">
                      <div class="half-hero-wrap">
                        ...
                        <h1>
                          Old and Modern <br /> cars on the <span>Newyork</span>
                          <br /> streets
                        </h1>
                        <h4>
                          Praesent eu massa vel diam laoreet elementum ac sed
                    ...
                    <div class="swiper-slide">
                      <div class="half-hero-wrap">
                        ...
                        <h1>
                          Design and <br />development <br /> of
                    ...
                    <div class="swiper-slide">
                      <div class="half-hero-wrap">
                        ...
                        <h1>
                          Original Design <br /> Features <br />With High
            ...
            <div class="hero-slider-img hero-slider-wrap_halftwo hidden-item">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <div
                      class="bg"
                      data-bg="./assets/images/bg/2.jpg"
                      data-swiper-parallax="20%"
                    />
                    <div class="overlay" />
                  </div>
              ...
              <div class="hero-corner-dec" />
              <div class="hero-corner-dec2" />
            </div>
            <!-- hero-slider-img  end-->
            <!-- slider-controls -->
            ...
            <div class="hero-slider_control-wrap">
              <div class="hsc hsc-prev">
                <span><i class="fal fa-angle-left" /></span>
              </div>
              <div class="hsc hsc-next">
                <span><i class="fal fa-angle-right" /></span>
              </div>
            </div>
            <!-- slider-controls end-->
            <a href="about.html" class="ajax start-btn"
              ><span>
                Start explore <i class="fal fa-long-arrow-right" /></span
              ></a
            >
          ...
          <div class="hero-decor-numb">
            <span>40.7143528 </span><span>-74.0059731 </span>
            <a
              href="https://www.google.com.ua/maps/"
              target="_blank"
              class="hero-decor-numb-tooltip">Based In NewYork</a
            >
          </div>
          <div class="hero-slider-wrap_pagination" />
      ...
      <div class="share-wrapper">
        <div class="close-share-btn"><i class="fas fa-long-arrow-left" /></div>
